...
public class MabatisPlusGenerator {
    ...
    private static final String URL = "jdbc:mysql://localhost:3306/shopping_mall?useUnicode=true&characterEncoding=utf8";
    private static final String USERNAME = "root";
    private static final String PASSWORD = "123";
    /**
     * 单个表名
     */
    private static String oneTable = "order_local";
...
//                 【实体】是否为lombok模型（默认 false）<a href="https://projectlombok.org/">document</a>
                ...
                new PackageConfig()
                        //.setModuleName("User")
                        // 自定义包路径
                        .setParent("com.gsh.shoppingmall")
                        // 这里是控制器包名，默认 web
